  ...
  <?php $images = get_field('image_loop');
    if($images):
      foreach($images as $image):?>
       <div class="small-12">
        <img data-original="http://i0.wp.com/<?php echo get_template_directory() . $image['sizes']['medium'];?>" width="300px" <?php //echo responsiveImage($image['id'], $image['sizes']['medium'], "300px");?> alt="">      
       </div>
      <?php endforeach;
  endif;?>
</div>